...
if [ $TARGET_TEST = all -o $TARGET_TEST = plugin ]; then
  ...
  $DCG d8:plugin:rest-resource -d $MODULE_DIR -a '{"name":"Qux","machine_name":"qux","plugin_label":"Example","plugin_id":"example"}'
