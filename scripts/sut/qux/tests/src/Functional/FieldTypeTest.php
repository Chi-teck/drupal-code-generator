...
class FieldTypeTest extends BrowserTestBase {
  ...
  public function testContentPage() {
    ...
    $this->assertSession()->elementExists('xpath', '//input[@name = "settings[foo]" and @value = "123"]');
    $edit = [
      'settings[foo]' => 555,
    ];
    ...
    $this->assertSession()->elementExists('xpath', '//input[@name = "settings[bar]" and @value = "Bla bla bla"]');
    $edit = [
      'settings[bar]' => 'Yo!',
    ];
    ...
    $this->assertSession()->elementExists('xpath', '//input[@name = "settings[bar]" and @value = "Yo!"]');
    $this->drupalGet($field_settings_url . '/storage');
    $this->assertSession()->elementExists('xpath', '//input[@name = "settings[foo]" and @value = "555"]');
    ...
    $this->assertSession()->elementExists('xpath', '//div[@class = "field__item" and text() = "Hello word"]');
  }
