...
class Project extends Generator {
  ...
  protected function generate() :void {
    ...
    $this->addFile('.gitignore', '_project/gitignore');
    $this->addFile('phpcs.xml', '_project/phpcs.xml');
    $this->addFile('scripts/composer/create_required_files.php', '_project/scripts/composer/create_required_files.php');

    if ($vars['behat']) {
      $this->addFile('tests/behat/behat.yml', '_project/tests/behat/behat.yml');
      $this->addFile('tests/behat/local.behat.yml', '_project/tests/behat/local.behat.yml');
      $this->addFile('tests/behat/bootstrap/BaseContext.php', '_project/tests/behat/bootstrap/BaseContext.php');
      $this->addFile('tests/behat/bootstrap/ExampleContext.php', '_project/tests/behat/bootstrap/ExampleContext.php');
      $this->addFile('tests/behat/features/example/user_forms.feature', '_project/tests/behat/features/example/user_forms.feature');
    }

    if ($vars['env']) {
      $this->addFile('.env.example', '_project/env.example');
      $this->addFile('load.environment.php', '_project/load.environment.php');
    }
    ...
    if ($vars['drush']) {
      $this->addFile('drush/drush.yml', '_project/drush/drush.yml');
      $this->addFile('drush/Commands/PolicyCommands.php', '_project/drush/Commands/PolicyCommands.php');
      $this->addFile('drush/sites/self.site.yml', '_project/drush/sites/self.site.yml');
      $this->addFile('scripts/sync-site.sh', '_project/scripts/sync-site.sh')->mode(0544);
    }
