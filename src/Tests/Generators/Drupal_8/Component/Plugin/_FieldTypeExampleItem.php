...
/**
 * @file
 * Contains \Drupal\field_type_example\Plugin\Field\FieldType\FieldTypeExampleItem.
 */

namespace Drupal\field_type_example\Plugin\Field\FieldType;
...
/**
 * Defines the 'field_type_example' field type.
 *
 * @FieldType(
 *   id = "field_type_example",
 *   label = @Translation("Field type example"),
 *   description = @Translation("TODO: Create a description"),
 ...
 * @DCG: }
 */
class FieldTypeExampleItem extends FieldItemBase {
