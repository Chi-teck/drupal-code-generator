...
namespace PHPSTORM_META {
  ...
  override(\Drupal\Core\Menu\ContextualLinkManager::createInstance(), map(['' => '\Drupal\Core\Menu\ContextualLinkInterface']));
  override(\Drupal\Core\Menu\ContextualLinkManager::getInstance(), map(['' => '\Drupal\Core\Menu\ContextualLinkInterface|bool']));
  ...
  override(\Drupal\Core\Menu\LocalTaskManager::createInstance(), map(['' => '\Drupal\Core\Menu\LocalTaskInterface']));
  override(\Drupal\Core\Menu\LocalTaskManager::getInstance(), map(['' => '\Drupal\Core\Menu\LocalTaskInterface|bool']));
