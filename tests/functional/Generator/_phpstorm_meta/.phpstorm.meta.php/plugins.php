...
namespace PHPSTORM_META {
  ...
  override(\Drupal\Core\Menu\ContextualLinkManagerInterface::createInstance(), map(['' => '\Drupal\Core\Menu\ContextualLinkInterface']));
  override(\Drupal\Core\Menu\ContextualLinkManagerInterface::getInstance(), map(['' => '\Drupal\Core\Menu\ContextualLinkInterface|bool']));
  override(\Drupal\Core\Menu\LocalActionManager::createInstance(), map(['' => '\Drupal\Core\Menu\LocalActionInterface']));
  override(\Drupal\Core\Menu\LocalActionManager::getInstance(), map(['' => '\Drupal\Core\Menu\LocalActionInterface|bool']));
  override(\Drupal\Core\Menu\LocalActionManagerInterface::createInstance(), map(['' => '\Drupal\Core\Menu\LocalTaskInterface']));
  override(\Drupal\Core\Menu\LocalActionManagerInterface::getInstance(), map(['' => '\Drupal\Core\Menu\LocalTaskInterface|bool']));
  override(\Drupal\Core\Menu\MenuLinkManagerInterface::createInstance(), map(['' => '\Drupal\Core\Menu\MenuLinkInterface']));
  override(\Drupal\Core\Menu\MenuLinkManagerInterface::getInstance(), map(['' => '\Drupal\Core\Menu\MenuLinkInterface|bool']));
